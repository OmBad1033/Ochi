...
function Footer() {
  return (
    <div className="flex gap-10 w-full h-screen bg-zinc-900 p-20 font-['Founders_Grotesk_Condensed']">
      <div className="w-1/2  h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[5vw] uppercase leading-none -mb-7 tracking-tighter">
            Eye
          </h1>
          <h1 className="text-[5vw] uppercase leading-none -mb-7 tracking-tighter">
            Opening
      ...
      <div className="w-1/2 justify-center">
        <div className="heading">
          <h1 className="text-[5vw] uppercase leading-none -mb-10 tracking-tighter uppercase">
            Presentations
          </h1>
          <div className="dets font-['Neue_Montreal'] py-20">
                {
                    ["Facebook", "Instagram", "LinkedIn"].map((item, index) => {
                        return <a href="#" className="block text-2xl font-light py-2" key={index}>{item}</a>
                    })
                }
